...
%             sat_name= strcat(num2str(NORAD_CAT_ID),'_',num2str(i));
            ...
            stkSetPropClassical(satPath,'J4Perturbation','ICRF',tstart,tstop,tstop-tstart,tstart,SEMIMAJOR_AXIS*1000,ECCENTRICITY,INCLINATION*dtr,ARG_OF_PERICENTER*dtr,RA_OF_ASC_NODE*dtr,MEAN_ANOMALY*dtr);
%             stkSetPropSGP4(satPath,tstart,tstop,tstop-tstart,num2str(NORAD_CAT_ID),tstart,MEAN_MOTION,ECCENTRICITY,INCLINATION*dtr,ARG_OF_PERICENTER*dtr,RA_OF_ASC_NODE*dtr,MEAN_ANOMALY*dtr,MEAN_MOTION_DOT,MEAN_MOTION_DDOT,BSTAR);
