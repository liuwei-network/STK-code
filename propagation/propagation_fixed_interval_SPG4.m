...
%             satPath = strcat('*/Satellite/' , sat_name);
%             stkNewObj('*/','Satellite', sat_name);
            stkSetPropSGP4(satPath,tstart,tstop,min(dT,tstop-tstart),num2str(NORAD_CAT_ID),orbitepoch,MEAN_MOTION,ECCENTRICITY,INCLINATION*dtr,ARG_OF_PERICENTER*dtr,RA_OF_ASC_NODE*dtr,MEAN_ANOMALY*dtr,MEAN_MOTION_DOT,MEAN_MOTION_DDOT,BSTAR);
%             stkSetPropClassical(satPath,'HPOP','J2000',tstart,tstop,dT,tstart,SEMIMAJOR_AXIS*1000,ECCENTRICITY,INCLINATION*dtr,ARG_OF_PERICENTER*dtr,RA_OF_ASC_NODE*dtr,MEAN_ANOMALY*dtr);
