...
%   path: configuration file path of mega-constellations
    ...
    global No_leo cycle No_snap tStop constellation dT leo_plane;
    ...
    for i =1:leo_plane
        for j=1:no
            ...
            stkSetPropClassical(sat_no,'TwoBody','J2000',0.0,tStop,dT,0,6371000 + Altitude * 10^3,0.0,inc,0.0,ra,ma);
