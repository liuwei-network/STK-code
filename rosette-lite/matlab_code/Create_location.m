...
global No_leo  No_fac tStart tStop No_snap Lat Long constellation;
load('Num_leo.mat');
load('Num_fac.mat');
index=1;
...
for i=1:No_leo
    disp(i);
    leo_info = strcat('*/Satellite/Sat_',constellation,num2str(num_leo(i))); 
%     leo_info=strcat('*/Satellite/Sat_Rosette_Low',num2str(num_leo(i)));
